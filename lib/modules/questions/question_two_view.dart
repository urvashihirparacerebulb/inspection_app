...
import 'package:inspection_app/modules/questions/question_three_view.dart';
...
class QuestionTwoView extends StatefulWidget {
  const QuestionTwoView({Key? key}) : super(key: key);

  @override
  State<QuestionTwoView> createState() => _QuestionTwoViewState();
}

class _QuestionTwoViewState extends State<QuestionTwoView> {
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      commonHeaderTitle(title: "Question 2",fontWeight: 3,fontSize: 1.2,isChangeColor: true,color: blackColor),
                                      commonVerticalSpacing(spacing: 10),
                                      commonHeaderTitle(title: "2 / 4",fontWeight: 2,fontSize: 0.75,isChangeColor: true,color: subFontColor),
                                    ],
                                  ),
                                )
                              ],
                            ...
                            commonHeaderTitle(
                                title: "Is there safety equipments - Fire Extinguisher, reflective markers are at place? all the safety equipments are ready for work at emergency situation?",
                                fontSize: 1.2,
                                isChangeColor: true,
                                height: 1.2,
                                color: blackColor
                      ...
                      children: [
                        ...
                        commonFillButtonView(
                          width: MediaQuery.of(context).size.width / 2,
                            ...
                            Get.to(() => const QuestionThreeView());
                        }, isLoading: false)
                      ],
                    ))
              ],
